  ...
  factory(require) {
    ...
    function Setup() {
      return h('section', { style: { padding: 20 } }, h('h3', null, '内嵌网页'),
        ...
        h('p', null, '更新扩展后，请在 chrome://extensions 中重新加载 DSH WebView Mode，再刷新 DSH。部分网站禁止内嵌或限制第三方登录，可使用“在 Chrome 打开”。Agent 可读取并操作当前内嵌网页的 DOM。请使用扩展 0.2.0，在扩展选项里添加本页来源后刷新 DSH；不支持 Canvas、嵌套框架和可信物理按键。'))
    }
